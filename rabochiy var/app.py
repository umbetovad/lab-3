...
from werkzeug.security import generate_password_hash, check_password_hash #для хэшиир.
...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql+psycopg2://postgres:12345@localhost/python"
